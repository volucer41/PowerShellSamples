#Parent function is Get-AuthToken from PowerShell gallery

function Get-AuthTokenAuto {
...
$clientId = "" # Microsoft Intune PowerShell app ID in Enterprise app
...
if($global:authToken){
    ...
    $TokenExpires = ($authToken.ExpiresOn.datetime - $DateTime).Minutes
        ...
        $global:authToken = Get-AuthTokenAuto -User $User -Password "$Password"
